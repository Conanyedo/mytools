...
/bin/rm -rf ~/Library/Application\ Support/com.operasoftware.OperaGX/Service\ Worker/CacheStorage/* &>/dev/null
...
/bin/rm -rf ~/Library/Application\ Support/Slack/Code\ Cache/* &>/dev/null
...
/bin/rm -rf ~/Library/Application\ Support/Code/CachedExtensions/* &>/dev/null
/bin/rm -rf ~/Library/Application\ Support/Code/CachedExtensionVSIXs/* &>/dev/null

cd ~/Library/Application\ Support/discord/Cache/ &>/dev/null
/usr/bin/find . -delete
cd ~
/bin/rm -rf ~/Library/Application\ Support/discord/0.0.* &>/dev/null
/bin/rm -rf ~/Library/Application\ Support/discord/Code\ Cache/* &>/dev/null

/bin/rm -rf ~/Library/Application\ Support/Spotify/PersistentCache/* &>/dev/null

/bin/rm -rf ~/Library/Application\ Support/Google/Chrome &>/dev/null
